...
class Lambdasian {
  constructor(objAttr){
    ...
    this.age = objAttr.age;
    this.location = objAttr.location;
  }
  speak(){
...
class ProjectManager extends Instructor{
   constructor(projManagerAttr){
     super(projManagerAttr);
     this.gradClassName = projManagerAttr.gradClassName;
     this.favInstructor = projManagerAttr.favInstructor;
   }
   standUp(channel){
